...
public class OrderService {
    ...
    public Order addOrder(Order order) {
        ...
        logger.info("OrderService:addOrder request payload {} ", Mapper.mapToJson(order));
        order.setOrderPlacedDate(new Date());
        order.setTransactionId(UUID.randomUUID().toString());
        orderList.add(order);
        logger.info("OrderService:addOrder response  {} ", Mapper.mapToJson(order));
    ...
    public List<Order> getOrders() {
        ...
        list = orderList;
        logger.info("OrderService:getOrders response  {} ", Mapper.mapToJson(orderList));
